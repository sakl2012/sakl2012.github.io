...
<div class="container">
    ...
    <div class="kol-banner-card">
        ...
        <div class="kol-stats">
            <div class="stat-box">
                <div class="stat-val" id="statTotalPosts">12,865</div>
                <div class="stat-lbl">收錄貼文總數</div>
            </div>
            <div class="stat-box">
                <div class="stat-val">3.5 年</div>
                <div class="stat-lbl">歷史時間跨度 (創號至今)</div>
            </div>
            <div class="stat-box">
    ...
    <div class="controls-card">
        ...
        <div class="timeline-bar">
            ...
            <div class="year-btn-group" id="yearBtnGroup">
                <button class="year-btn active" data-year="ALL" onclick="setYear('ALL')">全部年份 (12,865)</button>
                ...
                <button class="year-btn" data-year="2024" onclick="setYear('2024')">2024 年 (528)</button>
                <button class="year-btn" data-year="2023" onclick="setYear('2023')">2023 年 (2,798 熊轉牛起點)</button>
            </div>
            <div>
